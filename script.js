var w = (c.width = window.innerWidth),
  ...
  hh = h / 2,
  opts = {
    strings: ["HAPPY", "BIRTHDAY", "NAMHIPHOPMAIDINH!"],
    charSize: 50,
    charSpacing: 50,
    lineHeight: 80,
    ...
    fireworkBaseReachTime: 45, // Increased from 30
    ...
    fireworkCircleFadeBaseTime: 10, // Increased from 10
    fireworkCircleFadeAddedTime: 5, // Increased from 5
